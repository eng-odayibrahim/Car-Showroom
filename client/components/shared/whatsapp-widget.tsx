...
export default function WhatsAppWidget() {
  ...
  return (
    <motion.a
      ...
      id="wa-fab-btn"
      className="fixed bottom-6 right-6 z-[9998] flex items-center justify-center w-14 h-14 rounded-full cursor-pointer"
      ...
      {pulse && (
        <>
          <span
            ...
            style={{ background: 'rgba(37,211,102,0.3)', animationDuration: '1.6s' }}
          />
          <span
            className="absolute inset-0 rounded-full animate-ping"
            style={{ background: 'rgba(37,211,102,0.15)', animationDuration: '2.4s', animationDelay: '0.5s' }}
          />
        </>
      )}
